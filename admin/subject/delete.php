...
if (isset($_POST['btnDelete'])) {
    ...
    // Delete subject
    $strSql = "DELETE FROM subjects WHERE id = ?";
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Delete Subject</li>
        </ol>
    </nav>
    ...
    <form class="border p-4 rounded" method="POST">
        ...
        <ul class="mb-3">
            <li>
                <strong>Subject Code:</strong> <?php echo htmlspecialchars($recPersons['subject_code']); ?>
            </li>
            <li>
                <strong>Subject Name:</strong> <?php echo htmlspecialchars($recPersons['subject_name']); ?>
            </li>
        </ul>

        <div class="d-flex">
            <button class="btn btn-secondary me-2" type="button" id="btnCancel" onclick="window.location.href='add.php'">Cancel</button>
